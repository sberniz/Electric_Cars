...
column1 =  dbc.Col(
    [
        ...
        dcc.Dropdown(
            ...
            className='mb-5',
            clearable=False,
            value=X_test['Model Year'].iloc[0] 
        ),
        dcc.Markdown('#### Make'), 
        dcc.Dropdown(
            id='Make', 
        ...
        dcc.Dropdown(
            ...
            className='mb-5',
            clearable=False,
            value=X_test['Electric Vehicle Type'].iloc[0] 
        ),
        ...
        dcc.Dropdown(
            ...
            className='mb-5',
            clearable=False,
            value=X_test['Clean Alternative Fuel Vehicle (CAFV) Eligibility'].iloc[0] 
        ),   
    ],
    md=4,
)
